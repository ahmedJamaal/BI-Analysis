...
(function() {
  ...
  if(typeof document == "undefined" || (hasSources && document.location.href.indexOf("debug=true") > 0)) {
    requireCfg['paths']['analyzer'] = prefix;
  } else {
    requireCfg['paths']['analyzer'] = prefix + '/compressed';
  }

  requireCfg.paths["analyzer/resources"] = CONTEXT_PATH + "content/analyzer/resources";

  // This file is always in the non-compressed location.
  requireCfg.paths["analyzer/vizApi.conf"] = prefix + "/analyzer.vizApi.conf";
  ...
  requireModules["analyzer/vizApi.conf"] = {type: "pentaho/config/spec/IRuleSet"};
})();
