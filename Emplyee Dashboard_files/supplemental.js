define(["../_base/lang","../i18n"],function(n,i){var a={};return n.setObject("dojo.cldr.supplemental",a),
a.getFirstDayOfWeek=function(n){var i={bd:5,mv:5,ae:6,af:6,bh:6,dj:6,dz:6,eg:6,iq:6,
ir:6,jo:6,kw:6,ly:6,ma:6,om:6,qa:6,sa:6,sd:6,sy:6,ye:6,ag:0,ar:0,as:0,au:0,br:0,bs:0,
bt:0,bw:0,by:0,bz:0,ca:0,cn:0,co:0,dm:0,"do":0,et:0,gt:0,gu:0,hk:0,hn:0,id:0,ie:0,
il:0,"in":0,jm:0,jp:0,ke:0,kh:0,kr:0,la:0,mh:0,mm:0,mo:0,mt:0,mx:0,mz:0,ni:0,np:0,
nz:0,pa:0,pe:0,ph:0,pk:0,pr:0,py:0,sg:0,sv:0,th:0,tn:0,tt:0,tw:0,um:0,us:0,ve:0,vi:0,
ws:0,za:0,zw:0},s=a._region(n),m=i[s];return void 0===m?1:m},a._region=function(n){
n=i.normalizeLocale(n);var a=n.split("-"),s=a[1];return s?4==s.length&&(s=a[2]):s={
...
zza:"tr"}[a[0]],s},a.getWeekend=function(n){var i={"in":0,af:4,dz:4,ir:4,om:4,sa:4,
ye:4,ae:5,bh:5,eg:5,il:5,iq:5,jo:5,kw:5,ly:5,ma:5,qa:5,sd:5,sy:5,tn:5},s={af:5,dz:5,
ir:5,om:5,sa:5,ye:5,ae:6,bh:5,eg:6,il:6,iq:6,jo:6,kw:6,ly:6,ma:6,qa:6,sd:6,sy:6,tn:6
},m=a._region(n),e=i[m],r=s[m];return void 0===e&&(e=6),void 0===r&&(r=0),{start:e,
end:r}},a});